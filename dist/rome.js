...
function calendar (input, calendarOptions) {
  ...
  function assign () {
    api.id = input.dataset[ikey] = index.push(api) - 1;
  }
...
},{"./defaults":60,"./dom":61,"contra":2,"lodash.clonedeep":4,"lodash.throttle":50,"raf":58}],63:[function(_dereq_,module,exports){
