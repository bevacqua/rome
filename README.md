...
`min`             | The calendar won't allow the user to pick dates before `min`. Takes `string`, `Date`, `moment`.
`max`             | The calendar won't allow the user to pick dates past `max`. Takes `string`, `Date`, `moment`.
